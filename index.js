...
function onReady() {
  ...
  screen.on("display-metrics-changed", function () {
    client.write(
      ...
      consts.eventNames.displayEventMetricsChanged,
      {
        displays: {
          all: screen.getAllDisplays(),
          primary: screen.getPrimaryDisplay(),
  ...
  ipcMain.on(consts.eventNames.ipcEventMessageCallback, (event, arg) => {
    ...
    client.write(
      arg.targetID,
      consts.eventNames.windowEventMessageCallback,
      payload
    );
  });
    ...
    switch (json.name) {
      ...
      case consts.eventNames.appCmdUncaughtException:
        process.on('uncaughtException', (error) => {
          client.write(consts.targetIds.app, consts.eventNames.appEventUncaughtException, { error: JSON.stringify(error, Object.getOwnPropertyNames(error)) })
        })
        break;
      // Dock
      case consts.eventNames.dockCmdBounce:
        ...
        client.write(
          consts.targetIds.dock,
          consts.eventNames.dockEventBouncing,
          { id: id }
        );
        break;
      case consts.eventNames.dockCmdBounceDownloads:
        ...
        client.write(
          consts.targetIds.dock,
          consts.eventNames.dockEventDownloadsBouncing
        );
        break;
      case consts.eventNames.dockCmdCancelBounce:
        ...
        client.write(
          consts.targetIds.dock,
          consts.eventNames.dockEventBouncingCancelled
        );
        break;
      ...
      case consts.eventNames.dockCmdSetBadge:
        ...
        client.write(
          consts.targetIds.dock,
          consts.eventNames.dockEventBadgeSet
        );
        break;
        ...
        elements[json.targetID].webRequest.onBeforeSendHeaders(
          ...
          (details, callback) => {
            registerCallback(
              ...
              { details },
              consts.eventNames.sessionEventWebRequestOnBeforeSendHeaders,
              callback
            );
          }
        );
        break;
      case consts.eventNames.sessionEventWebRequestOnBeforeSendHeadersCallback:
        executeCallback(
          consts.eventNames.sessionEventWebRequestOnBeforeSendHeadersCallback,
          json,
      ...
      case consts.eventNames.sessionCmdClearCache:
        elements[json.targetID].clearCache().then(() => {
          client.write(
            json.targetID,
            consts.eventNames.sessionEventClearedCache
          );
        });
        break;
      case consts.eventNames.sessionCmdFlushStorage:
        ...
        client.write(
          json.targetID,
          consts.eventNames.sessionEventFlushedStorage
        );
        break;
      ...
      case consts.eventNames.sessionCmdGetCookies:
        elements[json.targetID].cookies.get({}).then((cookies) => {
          client.write(
            json.targetID,
            consts.eventNames.sessionEventCookiesGet,
            { cookies }
          );
        });
        break;
      ...
      case consts.eventNames.protocolEventInterceptStringProtocolCallback:
        executeCallback(
          consts.eventNames.protocolEventInterceptStringProtocol,
          json,
      ...
      case consts.eventNames.subMenuCmdInsert:
        elements[json.targetID].insert(
          json.menuItemPosition,
          menuItemCreate(json.menuItem)
        );
        setMenu(json.menuItem.rootId);
      ...
      case consts.eventNames.webContentsEventLoginCallback:
        executeCallback(consts.callbackNames.webContentsLogin, json, [
          json.username,
          json.password,
        ]);
        break;
      ...
      case consts.eventNames.browserViewCmdLoadUrl:
        elements[json.targetID].webContents
          ...
          .then(() => {
            client.write(
              json.targetID,
              consts.eventNames.browserViewEventLoadedUrl
            );
          });
        break;
      ...
      case consts.eventNames.windowCmdRemoveBrowserView:
        ...
        client.write(
          json.targetID,
          consts.eventNames.windowEventRemoveBrowserView
        );
        break;
      ...
      case consts.eventNames.windowCmdMessageCallback:
        ...
        if (typeof json.callbackId !== "undefined")
          m.callbackId = json.callbackId;
        elements[json.targetID].webContents.send(
      ...
      case consts.eventNames.windowCmdMove:
        elements[json.targetID].setPosition(
          json.windowOptions.x,
          json.windowOptions.y,
          true
        );
        break;
      case consts.eventNames.windowCmdResize:
        elements[json.targetID].setSize(
      ...
      case consts.eventNames.windowCmdUpdateCustomOptions:
        client.write(
          json.targetID,
          consts.eventNames.windowEventUpdatedCustomOptions,
          json.windowOptions
        );
        break;
      case consts.eventNames.windowCmdWebContentsExecuteJavascript:
        elements[json.targetID].webContents
          ...
          .then(() =>
            client.write(
              json.targetID,
              consts.eventNames.windowEventWebContentsExecutedJavaScript
            )
          );
        break;
          ...
          .then(() => {
            elements[json.targetID].webContents.session
              ...
              .then(() =>
                client.write(
                  json.targetID,
                  consts.eventNames.windowEventWebContentsSetProxy
                )
              );
          });
        break;
...
function setMenu(rootId) {
  let menu = null;
  if (
    typeof menus[rootId] !== "undefined" &&
    typeof elements[menus[rootId]] !== "undefined"
  ) {
  ...
  if (rootId === consts.targetIds.app) {
    ...
    rootId === consts.targetIds.dock &&
    typeof app.dock !== "undefined"
  ) {
...
function windowCreateFinish(json) {
  ...
  elements[json.targetID].loadURL(
    json.url,
  ...
  elements[json.targetID].on("close", (e) => {
    if (
      typeof windowOptions[json.targetID] !== "undefined" &&
      typeof windowOptions[json.targetID].custom !== "undefined"
    ) {
      if (
        ...
        let buttonId = dialog.showMessageBoxSync(
          null,
          windowOptions[json.targetID].custom.messageBoxOnClose
        );
        if (
          typeof windowOptions[json.targetID].custom.messageBoxOnClose
            .confirmId !== "undefined" &&
  ...
  elements[json.targetID].webContents.on(
    ...
    (event, oldUrl, newUrl) => {
      client.write(
        json.targetID,
        consts.eventNames.windowEventDidGetRedirectRequest,
        {
          newUrl: newUrl,
          oldUrl: oldUrl,
        }
  ...
  if (
    typeof json.windowOptions.appDetails !== "undefined" &&
