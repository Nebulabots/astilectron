    ...
    rl.on("line", function (line) {
        ...
        switch (json.name) {
            ...
            case consts.eventNames.browserViewCmdLoadUrl:
                views[json.targetID].webContents.loadURL(json.url, json.load).then(() => {
                    client.write(json.targetID, consts.eventNames.browserViewEventLoadedUrl);
                });
                break;
            ...
            case consts.eventNames.browserViewCmdGetBounds:
                ...
                client.write(json.targetID, consts.eventNames.browserViewEventGetBounds, bounds);
                break;
            // Window
            case consts.eventNames.windowCmdSetBrowserView:
                elements[json.targetID].setBrowserView(json.viewTargetID);
                break;
