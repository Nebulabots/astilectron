...
module.exports = {
  ...
  eventNames: {
    ...
    browserViewCmdLoadUrl: "browser.view.cmd.loadurl",
    browserViewCmdWebContentsExecuteJavascript: "browser.view.cmd.webcontents.execute.javascript",
    browserViewCmdWebContentsSetProxy: "browser.view.cmd.webcontents.set.proxy",
    ...
    browserViewCmdSetBounds: "browser.view.cmd.setbounds",
    browserViewCmdGetBounds: "browser.view.cmd.getbounds",
